...
public sealed class ValidationChecklistStore
{
    ...
    [
        ...
        new("computer-name", "Имя компьютера", "Введите допустимое имя, примените переименование, перезагрузите Windows и откройте Easyaller снова.", "После перезагрузки Windows использует новое имя; очередь самопроверки сохранилась."),
